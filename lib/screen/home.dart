...
import 'package:request_api/screen/current_loc.dart';
...
class _HomeState extends State<Home> {
  ...
  void initState() {
    super.initState();
    cuaca = fetchWeather(city: kota, state: prov, country: negara);
  }
            ...
            body: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                    setBackground(snapshot.data.data.current.weather.ic),
                  ),
                  // image: NetworkImage(
                              ...
                              children: [
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        "Cek udara kotamu! (Khusus Banten)",
